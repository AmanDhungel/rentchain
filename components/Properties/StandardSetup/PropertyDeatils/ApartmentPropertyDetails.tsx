...
export default function ApartmentPropertyDetailsStep({
  onPrev,
  onNext,
}: {
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input {...register("bedRoom")} required placeholder="e.g. 2" />
            </div>
            ...
            <div className="space-y-2">
              <h1 className="text-[17px] font-medium">Parking Included</h1>
              <div className="flex items-center ml-3">
                ...
                <span className="text-sm font-medium text-gray-700">
                  Yes, this property has parking included
                </span>
              </div>
            </div>
          </div>
