...
export default function VillaPropertyDetailsStep({
  onPrev,
  onNext,
}: {
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input {...register("bedRoom")} placeholder="e.g. 10" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input {...register("garageSpaces")} placeholder="e.g., 50" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center ml-3">
                ...
                <span className="text-sm font-medium text-gray-700">
                  Yes, this property has swimming pool
                </span>
              </div>
            </div>
            <div className="space-y-2">
              <h1 className="text-[17px] font-medium">Garden/Yard</h1>
              <div className="flex items-center ml-3">
                <Checkbox
                  {...register("garden")}
                  className="mr-2 data-[state=checked]:border-orange-500 data-[state=checked]:bg-orange-500"
                />
                <span className="text-sm font-medium text-gray-700">
                  Yes, this property has garden/yard
                </span>
              </div>
            </div>
          </div>
