...
export default function CommercialPropertyDetailsStep({
  onPrev,
  onNext,
}: {
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
            <div className="space-y-2">
              <Label>Office Spaces </Label>
              <Select {...register("officeSpaces")}>
            ...
            <div className="space-y-2">
              ...
              <Input {...register("parking")} placeholder="e.g., 42" />
            </div>

            <div className="space-y-2">
              <Label>Floor Area (sq ft)</Label>
              <Input {...register("floorArea")} placeholder="e.g., 5000" />
            </div>

            <div className="space-y-2">
              <h1 className="text-[17px] font-medium">Elevator</h1>
              <div className="flex items-center ml-3">
                ...
                <span className="text-sm font-medium text-gray-700">
                  Yes, this property has elevator
                </span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                {...register("zoningType")}
                placeholder="eg. Commericial, Mixed-Use"
              />
            </div>
          </div>
        </div>
