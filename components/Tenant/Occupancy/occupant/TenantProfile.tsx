...
import VerificationHistory from "./History";
...
const StatCard: FC<Stat> = ({ icon: Icon, label, value, color, index }) => {
  return (
    <Card className="flex h-24 items-start justify-center p-4">
      <div className="flex items-center">
        ...
        <div className="-mt-3 ml-2">
          <div
            className={`text-sm text-black py-1 px-2 rounded-md mt-1 
...
const OccupantTenantProfile: FC = () => {
    ...
    <div className="min-h-screen pl-0 md:pl-0  p-4 md:p-8 font-sans">
      <div className="flex justify-between items-center mb-10 ">
        <h1 className="flex gap-2">
          ...
          <span className="flex text-xl -mt-1 font-semibold flex-col">
            {" "}
            Sarah Johnson
            <span className="text-gray-400 text-sm ">Spouse • US Citizen</span>
          </span>
        </h1>
      </div>
...
export default OccupantTenantProfile;
