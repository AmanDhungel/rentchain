        ...
        {AR_AGING_DATA.map((item, index) => (
          <div key={item.label} className="flex justify-between items-center">
            <span
              ...
              } ${index === 2 || index === 3 ? "text-red-500 font-bold" : ""}`}>
              {item.label}
            </span>
            <span
              className={`${
              ...
              ${index === 1 && "text-orange-600 font-bold"}
              ${index === 2 || index === 3 ? "text-red-500 font-bold" : ""}`}>
              {item.amount}
            </span>
          </div>
...
const ReceiptsCard: React.FC = () => {
  ...
  return (
    <DashboardCard
      ...
      icon={Receipt}
      className="h-full flex flex-col">
      <div className="text-3xl font-bold text-green-500 mb-2 items-center text-center">
        $3,600
      </div>
      <p className="text-sm text-gray-500 mb-6 text-center">{8} transactions</p>
      <hr className="rounded-md border-gray-400 w-[97%] m-auto mt-0 mb-1" />

      <div className="flex justify-between items-end text-sm text-red-500 font-medium mb-1">
...
const AccountingBilling: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pl-0 p-4 sm:p-8 sm:pl-0 ">
