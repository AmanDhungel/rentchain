          ...
          render={({ field }) => (
            <div className="flex justify-between">
              <Label
                ...
                Digital Display
                <span className="text-gray-300 text-xs">
                  LCD/LED display for local readings
                </span>
              </Label>
              <Switch
                checked={field.value}
          ...
          render={({ field }) => (
            <div className="flex justify-between">
              <Label
                htmlFor="isSmart"
                className="flex flex-col text-start items-start">
                Remote Reading Capable
                <span className="text-gray-300 text-xs">
                  Can be read remotrly via communication
                </span>
              </Label>
              <Switch
                checked={field.value}
            ...
            render={({ field }) => (
              <div className="flex justify-between">
                <Label
                  ...
                  Enable Billing
                  <span className="text-gray-300 text-xs">
                    Include this meter in billing calculations
                  </span>
                </Label>
                <Switch
                  checked={field.value}
            ...
            render={({ field }) => (
              <div className="flex justify-between">
                <Label
                  ...
                  Tenant Access
                  <span className="text-gray-300 text-xs">
                    Allow Tenants to view readings and usage
                  </span>
                </Label>
                <Switch
                  checked={field.value}
            ...
            render={({ field }) => (
              <div className="flex justify-between">
                <Label
                  ...
                  <span className="text-gray-300 text-xs">
                    Automatically calculate consumption and costs
                  </span>
                </Label>
                <Switch
                  checked={field.value}
            ...
            render={({ field }) => (
              <div className="flex justify-between">
                <Label
                  ...
                  Usage Alets
                  <span className="text-gray-300 text-xs">
                    Seed alerts for unsual usage patterns
                  </span>
                </Label>
                <Switch
                  checked={field.value}
        ...
        <div className="flex justify-between items-center pt-6 border-t border-gray-100 p-6">
          {currentStep > 1 ? (
            <Button
              ...
              variant="secondary"
              onClick={onPrevious}
              className="flex items-center space-x-2 bg-gray-500 text-white hover:bg-gray-600">
              <ArrowLeft />
              <span>Previous</span>
            </Button>
          ) : (
          ...
          {currentStep < STEPS.length ? (
            <Button
              ...
              variant="outline"
              onClick={onNext}
              className="flex items-center space-x-2 ml-auto bg-orange-500 hover:bg-orange-600 text-white">
              <span>Next</span>
              <ArrowRight />
            </Button>
          ) : (
