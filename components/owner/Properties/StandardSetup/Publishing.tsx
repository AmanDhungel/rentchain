        ...
        <CardContent>
          <div className="grid grid-cols-4 gap-4">
            <label className="flex items-center space-x-2">
              <Checkbox {...register("publishingStatus.draft")} />
              <span>Draft</span>
            </label>
            <label className="flex items-center space-x-2">
              <Checkbox {...register("publishingStatus.published")} />
              <span>Published</span>
            </label>
            <label className="flex items-center space-x-2">
              <Checkbox {...register("publishingStatus.unlisted")} />
              <span>Unlisted</span>
            </label>
            <label className="flex items-center space-x-2">
              <Checkbox {...register("publishingStatus.archived")} />
              <span>Archived</span>
            </label>
          </div>
        </CardContent>
            ...
            <div>
              ...
              <div className="mt-2 border rounded p-3">
                <label className="flex items-center space-x-3">
                  <Checkbox {...register("unitSelected")} />
                  <div>
              ...
              <div className="mt-3 space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <Checkbox {...register("channels.rentchain")} />
                    <Select>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <Checkbox {...register("channels.partnerPortals")} />
                    <Select>
                      <SelectTrigger className="w-36">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <Checkbox {...register("channels.internalOnly")} />
                    <Select>
                      <SelectTrigger className="w-36">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="mt-2 grid grid-cols-2 gap-2">
                <label className="flex items-center space-x-2">
                  <Checkbox /> <span>Photos</span>
                </label>
                <label className="flex items-center space-x-2">
                  <Checkbox /> <span>Floor Plans</span>
                </label>
                <label className="flex items-center space-x-2">
                  <Checkbox /> <span>360° Tour</span>
                </label>
                <label className="flex items-center space-x-2">
                  <Checkbox /> <span>Virtual Staging</span>
                </label>
                <label className="flex items-center space-x-2">
                  <Checkbox /> <span>Drone Shots</span>
                </label>
                <label className="flex items-center space-x-2">
                  <Checkbox /> <span>Expatriates</span>
                </label>
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-col gap-2 mt-2">
                  <label className="flex items-center space-x-2">
                    <Checkbox /> <span>Fully Furnished</span>
                  </label>
                  <label className="flex items-center space-x-2">
                    <Checkbox /> <span>Recently Renovated</span>
                  </label>
                  <label className="flex items-center space-x-2">
                    <Checkbox /> <span>Safety Features</span>
                  </label>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    <label className="flex items-center space-x-2">
                      <Checkbox /> <span>Nearby Facilities</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <Checkbox /> <span>Unique Features</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <Checkbox /> <span>Appliances Included</span>
                    </label>
                    <label className="flex items-center space-x-2">
                      <Checkbox /> <span>Transport Links</span>
                    </label>
                  </div>
                </div>
