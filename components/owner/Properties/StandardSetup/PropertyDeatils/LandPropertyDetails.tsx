...
export default function LandPropertyDetailsStep() {
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
            <div className="space-y-2">
              ...
              <Select {...register("lotSize")} required>
                <SelectTrigger className="w-full border-none rounded-md bg-[#F6F9FF] ">
                  <SelectValue placeholder="e.g. 6787" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="6787">6787</SelectItem>
                  <SelectItem value="8000">8000</SelectItem>
                  <SelectItem value="7000">7000</SelectItem>
                  <SelectItem value="8787">8787</SelectItem>
                  <SelectItem value="8989">8989</SelectItem>
                </SelectContent>
              </Select>
            </div>
